...
6. GitHub Actions builds the NWNWiki data pack, builds the Windows installer, and uploads `latest.yml`, the installer `.exe`, and the `.blockmap` to the GitHub Release.
